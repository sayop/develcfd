                  ...
                  IF (n .EQ. 0) THEN
                     ...
                     CASE(2)
                        ...
                        CASE(2)
                           ...
                           DO l = 1, 3
                              nn(l) = 1
                              !> In this case, at least one of indices must be zero.
                              IF ((ii*nn(1) + jj*nn(2) + kk*nn(3)) .EQ. 0) THEN
                                 nn(l) = 0
                                 CYCLE
                              END IF
                              write(*,*) l, dom(m)%neighbor(ii*nn(1),jj*nn(2),kk*nn(3))
                           ...
                           lLoop: DO l = 1, 3
                              ...
                              IF (dom(m)%neighbor(ii*nn(1),jj*nn(2),kk*nn(3)) .NE. 0) THEN
                                 ...
                                 llLoop: DO ll = 1, 3
                                    IF (ll .EQ. l) CYCLE
                                    nn(ll) = 1
                                    IF (dom(n)%neighbor(ii*nn(1),jj*nn(2),kk*nn(3)) .NE. 0) THEN
                                       n = dom(n)%neighbor(ii*nn(1),jj*nn(2),kk*nn(3))
                                       nn = 1
                                       nn(l) = 0
                                       nn(ll) = 0
                                       iFound = 1
